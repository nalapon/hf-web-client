...
3.  **Testing That Actually Works.** I'm working on this. For now does not work.

## "One More Thing..." — Our Security Bunker

Here's what I've built under the hood to protect the users' identities.
...
4.  Start a gRPC-web proxy to enable browser communication. *Good luck with this*
...
const client = new FabricClient({
  ...
  wsUrl: "wss://your-fabric-gateway:port/ws/deliver",
});
