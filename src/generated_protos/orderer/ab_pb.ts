 ...
 *
 * @generated from message orderer.SeekNextCommit
 */
export type SeekNextCommit = Message<"orderer.SeekNextCommit"> & {
};

/**
 * Describes the message orderer.SeekNextCommit.
 * Use `create(SeekNextCommitSchema)` to create a new message.
 */
export const SeekNextCommitSchema: GenMessage<SeekNextCommit> = /*@__PURE__*/
...
export type SeekPosition = Message<"orderer.SeekPosition"> & {
  ...
  Type: {
    ...
    /**
     * @generated from field: orderer.SeekNextCommit next_commit = 4;
     */
    value: SeekNextCommit;
    case: "nextCommit";
...
export type SeekInfo = Message<"orderer.SeekInfo"> & {
   ...
   *
   * @generated from field: orderer.SeekInfo.SeekContentType content_type = 5;
   */
  contentType: SeekInfo_SeekContentType;
};
 ...
 *
 * @generated from enum orderer.SeekInfo.SeekContentType
 */
export enum SeekInfo_SeekContentType {
  /**
  ...
  /**
   * @generated from enum value: HEADER_WITH_SIG = 1;
   */
  HEADER_WITH_SIG = 1,
}

/**
 * Describes the enum orderer.SeekInfo.SeekContentType.
 */
export const SeekInfo_SeekContentTypeSchema: GenEnum<SeekInfo_SeekContentType> = /*@__PURE__*/
  enumDesc(file_orderer_ab, 6, 2);
