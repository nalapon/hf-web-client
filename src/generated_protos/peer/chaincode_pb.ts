...
export const file_peer_chaincode: GenFile = /*@__PURE__*/
  fileDesc("", [file_common_policies]);
 ...
 *
 * @generated from message protos.ChaincodeAdditionalParams
 */
export type ChaincodeAdditionalParams = Message<"protos.ChaincodeAdditionalParams"> & {
  /**
   * an indication that the peer can handle state write batches
   *
   * @generated from field: bool use_write_batch = 1;
   */
   ...
   *
   * @generated from field: uint32 max_size_write_batch = 2;
   */
   ...
   *
   * @generated from field: bool use_get_multiple_keys = 3;
   */
   ...
   *
   * @generated from field: uint32 max_size_get_multiple_keys = 4;
   */
  maxSizeGetMultipleKeys: number;
};

/**
 * Describes the message protos.ChaincodeAdditionalParams.
 * Use `create(ChaincodeAdditionalParamsSchema)` to create a new message.
 */
export const ChaincodeAdditionalParamsSchema: GenMessage<ChaincodeAdditionalParams> = /*@__PURE__*/
  messageDesc(file_peer_chaincode, 8);
