...
export const file_peer_query: GenFile = /*@__PURE__*/
  fileDesc("");
 ...
 *
 * @generated from message protos.JoinBySnapshotStatus
 */
export type JoinBySnapshotStatus = Message<"protos.JoinBySnapshotStatus"> & {
  /**
  ...
  /**
   * @generated from field: string bootstrapping_snapshot_dir = 2;
   */
  bootstrappingSnapshotDir: string;
};

/**
 * Describes the message protos.JoinBySnapshotStatus.
 * Use `create(JoinBySnapshotStatusSchema)` to create a new message.
 */
export const JoinBySnapshotStatusSchema: GenMessage<JoinBySnapshotStatus> = /*@__PURE__*/
  messageDesc(file_peer_query, 4);
